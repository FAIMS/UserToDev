...
%%%%TODO: Make sure the chosen font has a good bold appearance
...
\definetextbackground[middlegray][
...
\definetyping[XML]
\setuptyping[XML][option=xml, tab=4, style={\tfx\tt},
lines=yes, bodyfont=10.0pt,
before={\starttextbackground[gray]},
after={\stoptextbackground}]

\definetyping[Change]
\setuptyping[Change][option=xml, tab=4, style={\tfx\tt},
lines=yes, bodyfont=10.0pt,
before={\starttextbackground[middlegray]},
after={\stoptextbackground}]


\definetype[inlXML][option=XML]
