...
\placefigure[force][foo]{bar}{\externalfigure[images/image23.jpg][width=.5\textwidth]}
...
\placefigure[force][foo]{bar}{\externalfigure[images/image51.png][width=.5\textwidth]}

Once VirtualBox is installed, you can start the program. The default screen should look similar to the image below.

\placefigure[force][foo]{bar}{\externalfigure[images/image57.png][width=.5\textwidth]}
...
\placefigure[force][foo]{bar}{\externalfigure[images/image56.png][width=.5\textwidth]}
...
\placefigure[force][foo]{bar}{\externalfigure[images/image67.png][width=.5\textwidth]}
...
\placefigure[force][foo]{bar}{\externalfigure[images/image21.png][width=.5\textwidth]}

The pre-configured settings will appear. Select the "Import" option.

\placefigure[force][foo]{bar}{\externalfigure[images/image32.png][width=.5\textwidth]}
...
\placefigure[force][foo]{bar}{\externalfigure[images/image16.png][width=.5\textwidth]}
...
\placefigure[force][foo]{bar}{\externalfigure[images/image66.png][width=.5\textwidth]}
...
\placefigure[force][foo]{bar}{\externalfigure[images/image30.png][width=.5\textwidth]}
...
\placefigure[force][foo]{bar}{\externalfigure[images/image35.png][width=.5\textwidth]}
...
\placefigure[force][foo]{bar}{\externalfigure[images/image4.png][width=.5\textwidth]}
...
\placefigure[force][foo]{bar}{\externalfigure[images/image50.png][width=.5\textwidth]}
...
\placefigure[force][foo]{bar}{\externalfigure[images/image41.png][width=.5\textwidth]}

\placefigure[force][foo]{bar}{\externalfigure[images/image36.png][width=.5\textwidth]}

\placefigure[force][foo]{bar}{\externalfigure[images/image60.png][width=.5\textwidth]}
...
\placefigure[force][foo]{bar}{\externalfigure[images/image62.png][width=.5\textwidth]}
