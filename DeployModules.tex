...
\placefigure[force][foo]{bar}{\externalfigure[images/image28.png][width=.5\textwidth]}
...
\placefigure[force][foo]{bar}{\externalfigure[images/image29.png][width=.5\textwidth]}
...
\item
  \startblockquote
  Upload the Data Definition Schema (data_schema.xml).
  \stopblockquote
\item
  \startblockquote
  Upload the User Interface Schema (ui_schema.xml)
  \stopblockquote
\item
  \startblockquote
  Upload the User Interface Logic (ui_logic.bsh)
  \stopblockquote
\item
  \startblockquote
  Upload the Translation (Arch16n) file (faims.properties)
  \stopblockquote
\stopitemize
...
Where can you find the IP address of your FAIMS server?

Do you download your module wirelessly from the server, or directly to your device from a computer?
