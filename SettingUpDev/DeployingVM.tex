...
\placefigure[force][import-appliance]{Or use the "ctrl-I" keyboard shortcut.}{\externalfigure[image67.png][width=.5\textwidth]}
...
\placefigure[force][open-server]{Opening "FAIMS2 Web - Demo Server".}{\externalfigure[image21.png][width=.5\textwidth]}
