...
\placefigure[force][foo]{}{\externalfigure[image56.png][width=.5\textwidth]}
...
\placefigure[force][foo]{}{\externalfigure[image67.png][width=.5\textwidth]}
...
\placefigure[force][foo]{}{\externalfigure[image21.png][width=.5\textwidth]}

The pre-configured settings will appear. Select the \quotation{Import} option.

\placefigure[force][foo]{}{\externalfigure[image32.png][width=.5\textwidth]}
...
\placefigure[force][foo]{}{\externalfigure[image16.png][width=.5\textwidth]}

Once the setup is complete, "FAIMS2 Web - Demo Server" will appear in the menu on the left in VirtualBox.

\placefigure[force][foo]{}{\externalfigure[image46.png][width=.5\textwidth]}
...
\placefigure[force][foo]{}{\externalfigure[image66.png][width=.5\textwidth]}
...
\placefigure[force][foo]{}{\externalfigure[image30.png][width=.5\textwidth]}
...
\placefigure[force][foo]{}{\externalfigure[image35.png][width=.5\textwidth]}
...
\placefigure[force][foo]{}{\externalfigure[image4.png][width=.5\textwidth]}
...
\placefigure[force][foo]{}{\externalfigure[image55.png][width=.5\textwidth]}
