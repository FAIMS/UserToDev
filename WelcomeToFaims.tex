...
This document will teach individuals familiar with the FAIMS system of efficient, comprehensive data collection how to create their own modules. No programming experience is required; all you need is a computer, some idea of how to use it, and patience.
...
\subsection[section]{{\externalfigure[images/image68.png][width=.5\textwidth]}}{}
...
Once you've set up your FAIMS module, will it be possible to alter it to suit the needs of your team?

Can you use FAIMS to collect audio or video files as part of your field data?
