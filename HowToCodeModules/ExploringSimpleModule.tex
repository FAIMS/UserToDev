...
As an exercise, follow these instructions and produce your own copy of the module's code in {\tt module.xml}. Then save that to the server and run the generate.sh script to produce necessary files. Go to "create module" and upload the necessary files to the server as the "Simple Sample Module." 
