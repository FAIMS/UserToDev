...
This next element (\in{Codeblock}[codeAgentRole]), \inlXML{<Add_Agent_Role>}, designates a button element ('t="button"') that links to the tab group \inlXML{Agent_Role.} This will allow users to register new Agent Roles.
