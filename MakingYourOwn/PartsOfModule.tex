...
The Validation Schema, \quotation{validation.xml}, defines what kinds of data your team {\em should} be collecting. It allows the module to \quotation{validate,} or give a thumbs-up or thumbs-down to, your team's submissions to make sure the data being collected is thorough enough or makes sense.
