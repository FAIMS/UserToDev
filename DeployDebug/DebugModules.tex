...
On your computer, open up the command window (on Windows, press the Windows key, and search for \quotation{cmd}). Using {\tt cd} to change directory and {\tt ls} to list directory contents, navigate to where you installed the android-sdk.
